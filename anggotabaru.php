...
<center><div class="smue-szp_primary_nav smue-ce-child-detector "><i id="menu-toggle" aria-expanded="false"><img src="images/nav.png"> </i>  <button class="menu-toggle" id="menu-toggle" aria-expanded="false" aria-controls="site-navigation social-navigation">Menu</button>
	<div id="site-header-menu" class="site-header-menu">
		<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="Primary Menu">
			...
			<li id="menu-item-9" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-9" style="  " >
				<a href="formregister">Registrasi Devisi</a>
			</li>
			</ul>
			</div>
		</nav><!-- .main-navigation -->
...
<article id="post-6" class="post-6 post type-post status-publish format-standard hentry category-uncategorized">
	<header class="entry-header">
		...
		<h4 class="entry-title">List Anggota Baru</h4>
		<div id="button"><a href="#popup">JOIN GRUB</a></div>
		
		<div id="popup">
			<div class="window">
				<a href="#" class="close-button" title="Close">X</a>
				<h1>Scan Barcode Here to Join </h1>
...
<table  class="flat-table flat-table-2" width="100%" border="3" align="center" cellpadding="1" cellspacing="8">
 <thead align="center">
    ...
    <th width="200">Jenis Kelamin</td> 
    <th width="200">Jurusan</td>       
    <th width="200">Npm</td> 
    <th >Foto</td> 
 </thead>
 <?php
    ...
    $nomer=0;
     foreach( $Tampil as $hasil) {
            ...
            $npm              = stripslashes ($hasil['angkatan']);
            $Foto       = stripslashes ($hasil['photo']);
        {
    $nomer++;
?>
 <tbody>
  <tr align="center">
        ...
        <td><?=$jurusan?></td>
        <td><?=$npm?></td>
        <td> <?="<img src='image/".$hasil['photo']."'style='width:50px; height:50px;'"?></td>
  </tr>
  <?php  
        }
    }
...
<!-- </div> -->	
<br><b style="color: white">*Jika terdapat sesuatu kendala Contact by Line (ID Line : Erlinadiak )</b><br><br>
<b style="color: white">*Untuk informasi lebih lanjut, add OA KOLU (ID Line : @qve3218s )</b>
	</div><!-- .entry-content -->
	

	<!-- <footer class="entry-footer">
		<span class="byline"><span class="author vcard"><img alt='' src='https://secure.gravatar.com/avatar/a073701fa6e8fcf0135f69361adfae7b?s=49&amp;d=mm&amp;r=g' srcset='https://secure.gravatar.com/avatar/a073701fa6e8fcf0135f69361adfae7b?s=98&amp;d=mm&amp;r=g 2x' class='avatar avatar-49 photo' height='49' width='49' /><span class="screen-reader-text">Author </span> <span style="font-size: 15px; cursor:pointer">soft</span></span></span><span class="posted-on"><span class="screen-reader-text">Posted on </span><a href="blog/default-post.html" rel="bookmark"><time class="entry-date published updated" datetime="2017-02-22T11:57:54+00:00">February 22, 2017</time></a></span><span class="comments-link"></span>			</footer> --><!-- .entry-footer -->
</article><!-- #post-## -->
