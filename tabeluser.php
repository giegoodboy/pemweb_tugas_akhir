      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            <li class=""><a href="tabledataall.php"> <i><img src="cssdas/dasboard/icon/home.png"></i>Edit Pendaftaran </a></li>
...
<table border="1" id="datatable1" style="width: 100%;" class="table">
                    ...
                    <thead align="center">
                      <tr class="head">
                        <th>No</th>
                            <th>Nama Pemateri</th> 
                <th width="150">Jenis Seminar</th>
                <th  width="150">Judul seminar</th>       
...
?>
  <tr>
        ...
        <td><?=$npm?></td>
        <td><!-- <?=$Foto?> -->
          <?="<img src='image/".$hasil['photo']."'style='width:70px; height:70px;'"?>
        </td>
        <td><button type="sumbit" name="yoi" value="<?=$npm?>">DEL</button></td>
  </tr>
   <?php  
        }
    }
