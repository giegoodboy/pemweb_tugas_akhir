            ...
            <div class="container-fluid">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="proses_export_excel.php">Export to Excel</a>
...
<table border="1" id="datatable1" style="width: 100%;" class="table">
 ...
 <?php
    ...
    foreach( $Tampil as $hasil) {
            ...
            $nohp             = stripslashes ($hasil['telp']);
            $jenis_kelamin    = stripslashes ($hasil['jenis_kelamin']);
            $email            = stripslashes ($hasil['email_baru']);
            $alamat           = stripslashes ($hasil['alamat']);
            $divisi1          = stripslashes ($hasil['devisi1']);
            $divisi2          = stripslashes ($hasil['devisi2']);
            ...
            $idline           = stripslashes ($hasil['id_line']);
        {
    $nomer++;
?>
  <tr>
