      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Data Semua Divisi</h2>
            </div>
          </header>          <!-- Breadcrumb-->
...
<table  class="flat-table flat-table-2" width="100%" border="3" align="center" cellpadding="1" cellspacing="8">
 ...
 <?php
    ...
    $Cari="SELECT * FROM backup_data_devisi";
    $Tampil = $link->query($Cari);
    $nomer=0;
     foreach( $Tampil as $hasil) {
            $nama   = stripslashes ($hasil['nama_anggota_b']);
            $npm     = stripslashes ($hasil['npm_anggota_b']);
            $divisi       = stripslashes ($hasil['divisi_dipilih_b']);
