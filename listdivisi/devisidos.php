      ...
      <div class="page-content d-flex align-items-stretch"> 
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="#tablesDropdown" aria-expanded="false" data-toggle="collapse"> <i><img src="../cssdas/dasboard/icon/history.png"></i>List Data Pendaftaran</a>
              ...
              <ul id="formsDropdown" class="collapse list-unstyled ">
                ...
                <li ><a class="active" href="../dataall.php">Semua Data Backup</a></li><li><a href="../Pendaftarantahunan.php">Pendaftaran Pertahun</a></li>
                <li ><a class="active" href="../dataall.php">Semua Data Backup</a></li>
              </ul>
            </li>
            </li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Data Divisi DOS</h2>
            </div>
          </header>          <!-- Breadcrumb-->
...
<table  class="flat-table flat-table-2" width="100%" border="3" align="center" cellpadding="1" cellspacing="8">
 ...
 <?php
    ...
    $Cari="SELECT * FROM data_devisi where devisi_dipilih='DOS'";
