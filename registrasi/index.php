        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Registrasi Pengurus</h2>
                </div>
                <div class="card-body">
...
<!--                         <div class="form-row m-b-55">
                        ...
                        <div class="form-row p-t-20">
                            <label class="label label--block">Apakah anda yakin data telah benar?</label>
                            <div class="p-t-15">
                                <label class="radio-container m-r-55">Yaas
