      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class=""><a href="tabledataall.php"> <i><img src="cssdas/dasboard/icon/server.png"></i>Ubah Anggota Devisi </a></li>
            <!-- <li class=""><a href=""> <i><img src="public/dasboard/icon/accspv.png"></i>ACC Pengajuan </a></li> -->
            <li class=""><a href="viewimage.php"> <i><img src="cssdas/dasboard/icon/upload.png"></i>Approval Register</a></li>
            ...
            <li><a href="#tablesDropdown" aria-expanded="false" data-toggle="collapse"> <i><img src="cssdas/dasboard/icon/history.png"></i>List Data Pendaftaran</a>
              <ul id="tablesDropdown" class="collapse list-unstyled ">
                <li><a href="#">Peserta Di acc (Diterima)</a></li>
                <li><a href="#">Peserta Ditolak</a></li>
              ...
              <ul id="formsDropdown" class="collapse list-unstyled ">
                <li><a href="#">Daftar devisi Web</a></li>
                <li><a href="#">Daftar devisi Jaringan</a></li>
                <li><a href="#">Daftar devisi Dos</a></li>
                <li><a href="#">Daftar devisi Distro</a></li>
                <li><a href="#">Daftar Backup semua Devisi</a></li>
              </ul>
            </li>
            </li>
            ...
            <li><a href="#chartsDropdown" aria-expanded="false" data-toggle="collapse"> <i><img src="cssdas/dasboard/icon/rangking.png"></i>Komentar</a>
              <ul id="chartsDropdown" class="collapse list-unstyled ">
                <li><a href="#">Tampilkan Komentar</a></li>
...
<table  class="flat-table flat-table-2" width="100%" border="3" align="center" cellpadding="1" cellspacing="8">
 <thead align="center">
    ...
    <th >Nama</td> 
    <th width="200">Npm</td> 
    <th width="200">Divisi</td>       
 </thead>
 <?php
    include "connectdb.php";

    $Cari="SELECT * FROM data_devisi where devisi_dipilih='Web'";
    $Tampil = $link->query($Cari);
    $nomer=0;
     foreach( $Tampil as $hasil) {
            $nama   = stripslashes ($hasil['nama_anggota']);
            $npm     = stripslashes ($hasil['npm_anggota']);
            $divisi       = stripslashes ($hasil['devisi_dipilih']);
