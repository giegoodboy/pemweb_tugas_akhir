      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Status Publis Pendaftaran</h2>
            </div>
          </header>          <!-- Breadcrumb-->
...
?>
  <tr>
     ...
     <!--    <td align="center"><button type="sumbit" name="skuy" value="<?=$npm?>">Go</button></td> -->
...
<form method="post" action="../status/fungsitutup.php">
  <td align="center"><button type="sumbit" name="skuy">TUTUP PENDAFTARAN</button></td>
</form></br>
<form method="post" action="../status/fungsibuka.php">
  <td align="center"><button type="sumbit" name="skuy">BUKA PENDAFTARAN</button></td>
</form></br>
<form method="post" action="../status/satutombol.php">
  <td align="center"><button type="sumbit" name="skuy">Go ON/OFF</button></td>
</form>
