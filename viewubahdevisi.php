      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Ubah Anggota Divisi</h2>
            </div>
          </header>          <!-- Breadcrumb-->
              ...
              <div class="card">
                ...
                <div class="card-body">
                 ...
                 <div style="border:1px solid rgb(238,238,238); padding:10px; overflow:auto; width:100%; height:475px;">
                  <form action="accinsert.php" method="POST">
...
?>
  <tr>
        ...
        <td><?=$npm?></td>
        <td><?=$devisi?></td>
        <td><button type="sumbit" name="skuy" value="<?=$npm?>">DEL</button></td>
  </tr>
   <?php  
        }
    }
